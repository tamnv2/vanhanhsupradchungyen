...
reconciled_through_commit: a39f925f8235dfd454fda4e6010076ca2b348808
...
- Latest validation through canonical mutation design commit, run `34755193469`: SUCCESS.
...
- Preferred management-plane provisioning is persisted in `docs/PROJECTION_AUTH_PLAN.md`:
  ...
  - management provisioning should use authenticated Apps Script API execution restricted to the deploying identity rather than the anonymous Web App endpoint;
...
4. Implement/test canonical mutation helper and business commands in dependency order.
